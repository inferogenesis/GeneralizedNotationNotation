...
- **[cpomdp](cpomdp.md)**: Continuous-state active inference (`cpomdp >= 0.4.4, < 0.5`, optional `cpomdp` extra): exact Kalman filtering of the linear-Gaussian models plus enumerated expected-free-energy action search.
