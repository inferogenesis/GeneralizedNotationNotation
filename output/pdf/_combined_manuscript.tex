...
generated from the producer's token map at commit d09a9a6c3. A
...
\protect\breaktt{src/gnn/STEP\_INDEX.md} at commit d09a9a6c3; its footer
...
producer tokens at commit d09a9a6c3, and the panel is generated by
...
model-family manifest at commit d09a9a6c3, and its footer summarizes the
...
repository state at commit d09a9a6c3, not typed by hand. The producer
...
state at commit d09a9a6c3, so each figure here is regenerated from the
...
d09a9a6c3.}\label{fig:family_matrix}
\end{figure}
...
d09a9a6c3 --- the same token map that substitutes the prose counts, so
...
\breaktt{output/data/manuscript\_variables.json} (d09a9a6c3): a code
change that alters, for example, the test inventory (456 test files,
4900 test functions) propagates into the prose on the next regeneration
