...
generated from the producer's token map at commit 3508bfe69. A
...
\protect\breaktt{src/gnn/STEP\_INDEX.md} at commit 3508bfe69; its footer
...
producer tokens at commit 3508bfe69, and the panel is generated by
...
model-family manifest at commit 3508bfe69, and its footer summarizes the
...
repository state at commit 3508bfe69, not typed by hand. The producer
...
state at commit 3508bfe69, so each figure here is regenerated from the
...
3508bfe69.}\label{fig:family_matrix}
\end{figure}
...
3508bfe69 --- the same token map that substitutes the prose counts, so
...
\breaktt{output/data/manuscript\_variables.json} (3508bfe69): a code
