...
generated from the producer's token map at commit 995775361. A
...
\protect\breaktt{src/gnn/STEP\_INDEX.md} at commit 995775361; its footer
...
producer tokens at commit 995775361, and the panel is generated by
...
model-family manifest at commit 995775361, and its footer summarizes the
...
repository state at commit 995775361, not typed by hand. The producer
...
state at commit 995775361, so each figure here is regenerated from the
...
995775361.}\label{fig:family_matrix}
\end{figure}
...
995775361 --- the same token map that substitutes the prose counts, so
...
\breaktt{output/data/manuscript\_variables.json} (995775361): a code
